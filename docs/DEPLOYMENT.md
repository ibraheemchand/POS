...
3. Test `deploy/invento.exe` on a clean Windows account. Confirm startup creates the per-user database, schema compatibility passes, and a backup/restore smoke check succeeds.
