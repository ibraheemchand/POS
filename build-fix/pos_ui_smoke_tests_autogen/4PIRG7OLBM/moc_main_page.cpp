...
#include "../../../src/ui/pages/main_page.h"
...
void MainPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MainPage::*)(const QString & )>(_a, &MainPage::requestNavigation, 0))
            return;
    }
}
...
// SIGNAL 0
void MainPage::requestNavigation(const QString & _t1)
{
