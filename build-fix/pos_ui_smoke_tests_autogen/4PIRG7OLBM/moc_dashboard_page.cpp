...
#include "../../../src/ui/pages/dashboard_page.h"
...
void DashboardPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DashboardPage::*)(const QString & )>(_a, &DashboardPage::requestNavigation, 0))
            return;
    }
}
...
// SIGNAL 0
void DashboardPage::requestNavigation(const QString & _t1)
{
